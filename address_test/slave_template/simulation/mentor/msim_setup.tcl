...
# ----------------------------------------
# If slave_template is one of several IP cores in your
...
# ----------------------------------------
# ACDS 21.1 842 linux 2022.03.16.15:06:47
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "slave_template"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/slave_template.vhd"
}
