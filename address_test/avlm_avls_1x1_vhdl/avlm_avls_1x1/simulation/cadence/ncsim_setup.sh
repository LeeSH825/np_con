...
TOP_LEVEL_NAME="avlm_avls_1x1"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/hws_master/intelFPGA_lite/21.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
mkdir -p ./libraries/monitor_0_s0_translator/
mkdir -p ./libraries/master_0_m0_translator/
mkdir -p ./libraries/mm_interconnect_1/
mkdir -p ./libraries/mm_interconnect_0/
mkdir -p ./libraries/slave_0/
mkdir -p ./libraries/monitor_0/
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"           -work monitor_0_s0_translator   -cdslib ./cds_libs/monitor_0_s0_translator.cds.lib  
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"          -work master_0_m0_translator    -cdslib ./cds_libs/master_0_m0_translator.cds.lib   
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/avlm_avls_1x1_mm_interconnect_1.v"           -work mm_interconnect_1         -cdslib ./cds_libs/mm_interconnect_1.cds.lib        
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/avlm_avls_1x1_mm_interconnect_0.v"           -work mm_interconnect_0         -cdslib ./cds_libs/mm_interconnect_0.cds.lib        
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_mm_slave_bfm.sv"               -work slave_0                   -cdslib ./cds_libs/slave_0.cds.lib                  
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_mm_slave_bfm_vhdl_wrapper.sv"  -work slave_0                   -cdslib ./cds_libs/slave_0.cds.lib                  
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/altera_avalon_mm_slave_bfm_vhdl_pkg.vhd"     -work slave_0                   -cdslib ./cds_libs/slave_0.cds.lib                  
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/altera_avalon_mm_slave_bfm_vhdl.vhd"         -work slave_0                   -cdslib ./cds_libs/slave_0.cds.lib                  
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/addr_slave.vhd"                              -work monitor_0                 -cdslib ./cds_libs/monitor_0.cds.lib                
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_mm_master_bfm.sv"              -work master_0                  -cdslib ./cds_libs/master_0.cds.lib                 
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_mm_master_bfm_vhdl_wrapper.sv" -work master_0                  -cdslib ./cds_libs/master_0.cds.lib                 
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/altera_avalon_mm_master_bfm_vhdl_pkg.vhd"    -work master_0                  -cdslib ./cds_libs/master_0.cds.lib                 
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/altera_avalon_mm_master_bfm_vhdl.vhd"        -work master_0                  -cdslib ./cds_libs/master_0.cds.lib                 
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/avlm_avls_1x1.vhd"                                                                                                                          
fi
