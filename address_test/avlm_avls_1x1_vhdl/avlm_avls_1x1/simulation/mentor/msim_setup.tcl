...
# ----------------------------------------
# ACDS 21.1 842 linux 2022.03.20.03:35:17
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "avlm_avls_1x1"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/home/hws_master/intelFPGA_lite/21.1/quartus/"
}
...
ensure_lib                           ./libraries/monitor_0_s0_translator/  
vmap       monitor_0_s0_translator   ./libraries/monitor_0_s0_translator/  
ensure_lib                           ./libraries/master_0_m0_translator/   
vmap       master_0_m0_translator    ./libraries/master_0_m0_translator/   
...
ensure_lib                           ./libraries/monitor_0/                
vmap       monitor_0                 ./libraries/monitor_0/                
...
alias com {
  echo "\[exec\] com"
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mentor/verbosity_pkg.sv"                                                         -work altera_common_sv_packages
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mentor/avalon_mm_pkg.sv"                                                         -work altera_common_sv_packages
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mentor/avalon_utilities_pkg.sv"                                                  -work altera_common_sv_packages
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                  -L altera_common_sv_packages -work monitor_0_s0_translator  
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"                 -L altera_common_sv_packages -work master_0_m0_translator   
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/avlm_avls_1x1_mm_interconnect_1.v"                                               -work mm_interconnect_1        
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/avlm_avls_1x1_mm_interconnect_0.v"                                               -work mm_interconnect_0        
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mentor/altera_avalon_mm_slave_bfm.sv"               -L altera_common_sv_packages -work slave_0                  
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mentor/altera_avalon_mm_slave_bfm_vhdl_wrapper.sv"  -L altera_common_sv_packages -work slave_0                  
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/submodules/altera_avalon_mm_slave_bfm_vhdl_pkg.vhd"                                         -work slave_0                  
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/submodules/altera_avalon_mm_slave_bfm_vhdl.vhd"                                             -work slave_0                  
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/submodules/addr_slave.vhd"                                                                  -work monitor_0                
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mentor/altera_avalon_mm_master_bfm.sv"              -L altera_common_sv_packages -work master_0                 
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mentor/altera_avalon_mm_master_bfm_vhdl_wrapper.sv" -L altera_common_sv_packages -work master_0                 
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/submodules/altera_avalon_mm_master_bfm_vhdl_pkg.vhd"                                        -work master_0                 
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/submodules/altera_avalon_mm_master_bfm_vhdl.vhd"                                            -work master_0                 
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/avlm_avls_1x1.vhd"                                                                                                         
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altera_common_sv_packages -L monitor_0_s0_translator -L master_0_m0_translator -L mm_interconnect_1 -L mm_interconnect_0 -L slave_0 -L monitor_0 -L master_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev -L cyclonev_hssi $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -voptargs=+acc -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altera_common_sv_packages -L monitor_0_s0_translator -L master_0_m0_translator -L mm_interconnect_1 -L mm_interconnect_0 -L slave_0 -L monitor_0 -L master_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev -L cyclonev_hssi $TOP_LEVEL_NAME
}
