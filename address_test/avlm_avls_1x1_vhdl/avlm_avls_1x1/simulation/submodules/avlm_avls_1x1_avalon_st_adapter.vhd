-- avlm_avls_1x1_avalon_st_adapter.vhd
...
entity avlm_avls_1x1_avalon_st_adapter is
	generic (
		inBitsPerSymbol : integer := 115;
		inUsePackets    : integer := 1;
		inDataWidth     : integer := 115;
	...
	port (
		...
		in_0_data           : in  std_logic_vector(114 downto 0) := (others => '0'); --     in_0.data
		...
		out_0_data          : out std_logic_vector(114 downto 0);                    --    out_0.data
...
end entity avlm_avls_1x1_avalon_st_adapter;

architecture rtl of avlm_avls_1x1_avalon_st_adapter is
	component avlm_avls_1x1_avalon_st_adapter_channel_adapter_0 is
		port (
	...
	end component avlm_avls_1x1_avalon_st_adapter_channel_adapter_0;

	signal in_rst_0_reset_ports_inv : std_logic; -- in_rst_0_reset:inv -> channel_adapter_0:reset_n

begin

	inbitspersymbol_check : if inBitsPerSymbol /= 115 generate
	...
	indatawidth_check : if inDataWidth /= 115 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	outdatawidth_check : if outDataWidth /= 115 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	channel_adapter_0 : component avlm_avls_1x1_avalon_st_adapter_channel_adapter_0
		port map (
...
end architecture rtl; -- of avlm_avls_1x1_avalon_st_adapter
