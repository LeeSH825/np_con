...
# Sat Mar 19 00:01:44 KST 2022
# DO NOT MODIFY


# 
# monitor "custommonitor" v1.0
#  2022.03.19.00:01:44
# 
# 
...
set_module_property NAME monitor
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME custommonitor
...
set_fileset_property SIM_VHDL TOP_LEVEL addr_slave
...
# parameters
# 
add_parameter ADDRESS_WIDTH INTEGER 12
set_parameter_property ADDRESS_WIDTH DEFAULT_VALUE 12
...
add_interface_port s0 avs_s0_address address Input "((address_width-1)) - (0) + 1"
add_interface_port s0 avs_s0_waitrequest waitrequest Output 1
add_interface_port s0 avs_s0_burstcount burstcount Input "((burst_width-1)) - (0) + 1"
add_interface_port s0 avs_s0_byteenable byteenable Input "((byte_width-1)) - (0) + 1"
add_interface_port s0 avs_s0_write write Input 1
add_interface_port s0 avs_s0_writedata writedata Input "((data_width-1)) - (0) + 1"
...
add_interface_port m0 avm_m0_address address Output "((address_width-1)) - (0) + 1"
add_interface_port m0 avm_m0_waitrequest waitrequest Input 1
add_interface_port m0 avm_m0_burstcount burstcount Output "((burst_width-1)) - (0) + 1"
add_interface_port m0 avm_m0_byteenable byteenable Output "((byte_width-1)) - (0) + 1"
add_interface_port m0 avm_m0_write write Output 1
add_interface_port m0 avm_m0_writedata writedata Output "((data_width-1)) - (0) + 1"
